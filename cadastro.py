...
dados = lista_codigos
df = pd.DataFrame(dados, columns= ['codigo_str','descricao','tipo','quant','data_criacao'])
print(df)
df.to_excel('/home/clenio/Documentos/Projetos/Ferramenta_Cadastro_Python/cadastro.xlsx', index=False)
